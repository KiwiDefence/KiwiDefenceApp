...
export default function Footer({ sidebarOpen }: { sidebarOpen?: boolean }) {
  return (
    <footer className={`fixed bottom-0 z-40 border-t border-neutral-800 bg-black px-6 py-4 transition-all duration-300 ease-in-out right-0 ${sidebarOpen ? "left-56" : "left-20"}`}>
      <div className="flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-neutral-500 font-code">
